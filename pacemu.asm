; Pac-Man hardware emulation for the SAM Coupe (v1.0)
;
...
dip_5000:   .db %11111111   ; c21tdrlu     c=credit, 2=coin2, 1=coin1, t=rack test on/off ; down, right, left, up
                            ; rack test off, nothing else signalled
dip_5040:   .db %11111111   ; c--sdrlu     c=cocktail/upright ; s=service mode on/off ; down, right, left, up (player 2)
                            ; upright mode, service mode off, no controls pressed
dip_5080:   .db %11001001   ; -dbbllcc      d=hard/normal bb=bonus life at 10K/15K/20K/none ; ll=1/2/3/5 lives ; cc=freeplay/1coin1credit/1coin2credits/2coins1credit
...
start:      di
            ...
            ld  hl,palette+15
            ld  bc,$10f8
            .db $ed,$bb         ; set palette (this should be OTDR but Assembly Studio 8x gets it wrong!)
...
palette:    .db 0,127,34,123,85,106,110,96,6,68,29,25,99,122,122,119
...
;
flash_pills:
            ld  de,$1410    ; $14=pill, $10=pill-on colour
...
text_cols:  .db $00,$22,$99,$33,$99,$44,$99,$55,$99,$66,$99,$99,$99,$99,$cc,$ff
...
;
do_sound:
            ld  hl,$5051        ; voice 0 freq and volume
...
xy_to_addr: ld  b,y_conv/256
            ...
            .pad (($+$ff) & $ff00)  ; align to next 256-byte boundary
;
...
length:     .equ $ - $8000
            ...
            .pad (($+$ff) & $ff00) ; the tables below must be 256-byte aligned
...
textcol_tab: .pad $+$10
             ...
             .pad $+$80  ; 128 bytes of stack space - should be plenty
new_stack:
